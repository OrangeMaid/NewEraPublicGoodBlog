...
import cn.wangliang.blog.dto.ArticleDto;
import cn.wangliang.blog.dto.ArticleWithPictureDto;
...
import cn.wangliang.blog.util.Markdown2HtmlUtil;
...
//    }
    ...
    public List<Comment> listMessageByArticleId(@PathVariable Long id) {
        return commentService.listAllCommentByArticleId(id);
    }
    ...
    public String deleteMessage(@PathVariable Long id){
        messageService.deleteMessagetById(id);
        return null;
    }
     ...
     * 获取所有有效留言，供前台展示
     */
    @GetMapping("message/effList")
    public List<Message> listAllEffMessage(){
        return  messageService.listAllMessageByEffective();
    }
